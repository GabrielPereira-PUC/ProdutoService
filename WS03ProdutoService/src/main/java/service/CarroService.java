...
public class CarroService {
	...
	public void makeForm(int tipo, Carro carro, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umCarro += "\t\t</tr>";
			umCarro += "\t\t<tr>";
			umCarro += "\t\t\t<td>&nbsp;Modelo: <input class=\"input--register\" type=\"text\" name=\"modelo\" value=\""+ (tipo == FORM_INSERT ? "" : carro.getModelo()) +"\"></td>";
			umCarro += "\t\t\t<td>Marca: <input class=\"input--register\" type=\"text\" name=\"marca\" value=\""+ (tipo == FORM_INSERT ? "" : carro.getMarca()) +"\"></td>";
			umCarro += "\t\t\t<td>Ano: <input class=\"input--register\" type=\"number\" name=\"ano\" value=\""+ (tipo == FORM_INSERT ? "" : carro.getAno()) +"\"></td>";
			umCarro += "\t\t</tr>";
			umCarro += "\t\t<tr>";
			umCarro += "\t\t\t<td>Preço: <input class=\"input--register\" type=\"number\" step=\"0.01\" name=\"preco\" value=\""+ (tipo == FORM_INSERT ? "" : carro.getPreco()) +"\"></td>";
			umCarro += "\t\t\t<td colspan=\"2\" align=\"center\"><input type=\"submit\" value=\""+ buttonLabel +"\" class=\"input--main__style input--button\"></td>";
			umCarro += "\t\t</tr>";
			umCarro += "\t</table>";
			umCarro += "\t</form>";		
		...
		list += "\n<tr><td colspan=\"6\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Relação de Carros</b></font></td></tr>\n" +
        		...
        		"\t<td width=\"150\" align=\"center\"><b>Ações</b></td>\n" +
        		"</tr>\n";
		...
		for (Carro c : carros) {
			...
			list += "\n<tr bgcolor=\""+ bgcolor +"\">\n" + 
            		  ...
            		  "\t<td align=\"center\" valign=\"middle\"><a href=\"javascript:confirmarDeleteCarro(" + c.getId() + ", '" + c.getModelo() + "', '" + c.getMarca() + "');\"><img src=\"/image/delete.png\" width=\"20\" height=\"20\"/></a></td>\n" +
            		  "</tr>\n";
		}
		list += "</table>";		
	...
	public Object insert(Request request, Response response) {
		...
		Carro carro = new Carro(-1, modelo, marca, ano, preco);
